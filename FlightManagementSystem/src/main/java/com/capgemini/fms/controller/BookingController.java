...
public ResponseEntity<String>deletebooking(@PathVariable int bookingId) throws BookingException{
	  try {
		  ...
		  throw new BookingException("Id is not exists");
	  }
}

/************************************************************************************************************************
 * Method        updateBooking
 * Description   To update the booking from the database
 *                
 *                 
 *                   
 * Created By    Nishi Yadav
...
public ResponseEntity<String> updateBooking(@RequestBody Booking booking) {
    ...
    return new ResponseEntity<String>("Updated Booking",HttpStatus.OK); 
}
}
