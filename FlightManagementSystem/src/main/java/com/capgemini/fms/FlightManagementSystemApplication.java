...
public class FlightManagementSystemApplication  implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Users user1 =new Users(1,"user","Nishi","64839382","nishi@gmail.com");
		Users user2 =new Users(2,"user","Yadav","36573832","yadav@gmail.com");
		userDao.save(user1);
		userDao.save(user2);
		...
		Flight flight3 =new Flight(234,"Gerald R.Ford(CVN-78)",200,"Airbus A321");
		Flight flight4 =new Flight(234,"Nimitz(CVN-68)",250,"A320-214 CEO");
		Flight flight5 =new Flight(234,"Nimitz(CVN-68)",200,"A320-251 NEO");
		Flight flight6 =new Flight(234,"ACES",200,"Boeing 747-400");
		Flight flight7 =new Flight(234,"AARON AIRLINES",250,"Boeing 777-200LR");
